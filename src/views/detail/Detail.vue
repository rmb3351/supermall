...
export default {
  ...
  methods: {
    ...
    detailImageLoad() {
      ...
      //   console.log("_______________detailImage  params______________");
      ...
      //   console.log("_______________detailImage  comments______________");
      ...
      //   console.log("_______________detailImage  recommends______________");
